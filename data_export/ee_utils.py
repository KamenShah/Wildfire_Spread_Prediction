...
DATA_SOURCES = {
    ...
    DataType.VEGETATION_VIIRS: 'NOAA/VIIRS/001/VNP13A1', # 2012 - current
    DataType.DROUGHT_GRIDMET: 'GRIDMET/DROUGHT',         # 1980 - current
    DataType.WEATHER_ERA5: 'ECMWF/ERA5/DAILY',           # 1979 - 2020 07
    DataType.WEATHER_GRIDMET: 'IDAHO_EPSCOR/GRIDMET',    # 1980 - current
    DataType.GOES_17: 'NOAA/GOES/17/FDCF',               # 2018 - current
    DataType.POPULATION: 'CIESIN/GPWv411/GPW_Population_Density'  # 2000 - 2020
}
...
def split_days_into_train_eval_test(
  ...
  dates = []
  time_samples = (int(ee.Date.difference(end_date, start_date, unit='minute').getInfo()))//GOES_sampling

  # samplesPerDay = 1440//GOES_sampling 

  samples = list(range(time_samples))
  start_times = samples[::GOES_sampling]
