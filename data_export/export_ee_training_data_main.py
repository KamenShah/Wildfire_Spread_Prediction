...
flags.DEFINE_string('start_date', '2018-08-28',
                    'Start date to export in YYYY-MM-DD.')
flags.DEFINE_string('end_date', '2022-05-01',
                    'End date to export in YYYY-MM-DD (inclusive).')
flags.DEFINE_string('prefix', 'data', 'File prefix for output files.')
flags.DEFINE_string(
    'config_dir', '',
...
flags.DEFINE_float('eval_split_ratio', 0.2,
...
flags.DEFINE_integer('GOES_sampling', 5,
...
def main(argv):
  ...
  logging.info('GOES_sampling=%f', FLAGS.GOES_sampling)
  ...
  export_ee_data.export_ml_datasets(
      ...
      GOES_sampling=FLAGS.GOES_sampling
  )
